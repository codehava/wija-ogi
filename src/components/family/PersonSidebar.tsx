...
export function PersonSidebar({
    ...
    return (
        <div className={`fixed right-0 top-[72px] bottom-0 ${isEditing ? 'w-96' : 'w-80'} bg-white border-l border-stone-200 shadow-2xl overflow-y-auto z-50 animate-slide-in-right transition-all`}>
            <div className="p-4">
