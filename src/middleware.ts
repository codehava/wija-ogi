...
// Rate limiting for auth endpoints and other global protections
// ═══════════════════════════════════════════════════════════════════════════════
...
export function middleware(request: NextRequest) {
    ...
    // Rate limit auth endpoints (login/register): 10 requests per minute
    ...
    // Rate limit all write endpoints (POST/PUT/PATCH/DELETE): 30 per minute
    if (
